...
<div style="margin-left:30px">
<p><span class="ts">function</span><code class="function"> emailerrors(email_address, olderror)</code><br />
...
<div style="margin-left:60px">
<p><span class="ts">method</span><code class="method"> render(self, shownote=True)</code><br />
<div style="margin-left:75px"><p></p></div></p>
</div>
<div style="margin-left:60px">
<p><span class="ts">method</span><code class="method"> rendernote(self, note)</code><br />
...
<div style="margin-left:30px">
<p><span class="ts">function</span><code class="function"> write(cgi_response)</code><br />
<div style="margin-left:45px"><p>Converts a standard CGI-style string response into <code>header</code> and 
<code>output</code> calls.</p></div></p>
</div>
<div style="margin-left:30px">
...
<div style="margin-left:30px">
<p><span class="ts">class</span><code class="class"> Template(self, text, filename='<template>', filter=None, globals=None, builtins=None)</code><br />
<div style="margin-left:45px"><p></p></div></p>
<div style="margin-left:60px">
...
<div style="margin-left:60px">
<p><span class="ts">function</span><code class="function"> generate_code(text, filename)</code><br />
<div style="margin-left:75px"><p></p></div></p>
</div>
<div style="margin-left:60px">
...
<pre><code>&gt;&gt;&gt; class TestResult(TemplateResult):
...
<div style="margin-left:30px">
<p><span class="ts">class</span><code class="class"> Memoize(self, func)</code><br />
<div style="margin-left:45px"><p>'Memoizes' a function, caching its return values for each input.</p>
